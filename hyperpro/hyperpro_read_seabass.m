% hyperpro_read_seabass.m - Function called by 'hyperpro_extract_seabass.m' to 
% read SeaBASS data files
% 
% Syntax: [hyper_meta,hyper_utc_datetime,hyper_dat]=hyperpro_read_seabass(input_file)
%
% Inputs:
...
function [hyper_meta,hyper_utc_datetime,hyper_dat]=hyperpro_read_seabass(input_file)
...
hyper_utc_datetime=[hyper_date,' ',hyper_time];
% hyper_run_time=hyper_txt(:,10:17);
hyper_dat=str2num(hyper_txt);

hyper_meta=struct('lat',hyper_lat,'lon',hyper_lon,'date_time',hyper_utc_datetime,...
    'station',hyper_sta,'fields',hyper_hdr,'units',hyper_units);
