function [Az,El] = SolarAzEl_revised(UTC,Lat,Lon,Alt)
%% Revision History:
...
%
% Modified by Steven E. Lohrenz, 4/21/2025 Changed datenum to datetime
% convention
%--------------------------------------------------------------------------
...
% FUNCTION NO LONGER NEEDED - USING MATLAB INTERNAL COMMAND
